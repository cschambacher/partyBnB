          ...
          <div className="step1-form">
            <div className="placetype-form">
              ...
              <div className="property-type-list" id="myDIV">
                ...
                <ul>
                  <li
                    className={`property-type-list ${this.state.placeType ===
                      "Apartment" && "active"}`}
                    value="Apartment"
                    onClick={e => this.setState({ placeType: "Apartment" })}
                  >
                    Apartment
                  </li>
                  <li
                    className={`property-type-list ${this.state.placeType ===
                      "House" && "active"}`}
                    value="House"
                    onClick={e => this.setState({ placeType: "House" })}
                  >
                    House
                  </li>
                  <li
                    className={`property-type-list ${this.state.placeType ===
                      "Secondary unit" && "active"}`}
                    value="Secondary unit"
                    onClick={e =>
                      this.setState({ placeType: "Secondary unit" })
                    }
                  >
                    Secondary unit
                  </li>
                  <li
                    className={`property-type-list ${this.state.placeType ===
                      "Unique Space" && "active"}`}
                    value="Unique Space"
                    onClick={e => this.setState({ placeType: "Unique Space" })}
                  >
                    Unique Space
                  </li>
                  <li
                    className={`property-type-list ${this.state.placeType ===
                      "Hotel" && "active"}`}
                    value="Hotel"
                    onClick={e => this.setState({ placeType: "Hotel" })}
                  >
                    {" "}
                    Hotel
                  </li>
              ...
              <div className="property-type-guest">
                ...
                <div className="choice">
                  <input
                    ...
                    // value={false}
                    onChange={e =>
                      this.setState({ dedicatedGuestSpace: false })
                    }
                ...
                <div>
                  <div className="choice">
                    <input
                      ...
                      onChange={e =>
                        this.setState({
                          whatWillGuestsHave: e.currentTarget.value
                        })
                      }
                      checked={
                        this.state.whatWillGuestsHave === "all the space"
                      }
                    />
                    <label>Entire place</label>
                    <p>
                      Guests have the whole place to themselves. This usually
                      includes a bedroom, a bathroom, and a kitchen.
                    </p>
                  </div>
                  <div className="choice">
                    <input
                      ...
                      checked={
                        this.state.whatWillGuestsHave === "private space"
                      }
                    />
                    <label>Private place</label>
                    <p>
                      Guests have their own private room for their. Other areas
                      could be shared.
                    </p>
                  </div>
                  <div className="choice">
                    ...
                    <p>
                      Guests can have their partyh in a room or a common area
              ...
              <div className="placetype-listing">
                ...
                <div className="choice">
                  <input
                    ...
                    // value={true}
                    onChange={e =>
                      this.setState({ listingForOtherCompany: true })
                    }
                ...
                <div className="choice">
                  <input
                    ...
                    value={false}
                    onChange={e =>
                      this.setState({ listingForOtherCompany: false })
                    }
                    checked={this.state.listingForOtherCompany === false}
                  />
                  <label>No, that doesn’t sound like me</label>
                  <div className="choice">
                    This helps you get the right features for how you host—it
                    won’t show up to guests or impact how you show up in search.
                  </div>
                </div>
              </div>
            </div>
            <div className="next-back">
              ...
              <button
                className={`grn-btn ${this.state.placeType !== null &&
                  "sharpen"}`}
                disabled={this.state.placeType === null}
                onClick={() => {
                  this.props
                    .updateSpot(this.props.match.params.spotId, {
                    ...
                    .then(spot => {
                      ...
                      this.props.history.push(
                        `/location/${this.props.match.params.spotId}`
                      );
                    })
